...
function runMatter() {
  ...
  engine.world.gravity.scale = 0.1;
                                              // mathi ko default engine ko code ho
  ...
  var runner = Runner.create();
                                                               ...
                                                               // yo main scene only render gareko canvas ma
  var world = engine.world;
  world.gravity.scale = 0;

                                                                         // yo cursor ko pointer
  var attractiveBody = Bodies.circle(
  render.options.width / 2,
  render.options.height / 2,
  Math.max(dimensions.width / 36, dimensions.height / 36) / 2,
  {
    render: {
      fillStyle: `red`,
  ...
  World.add(world, attractiveBody);
                                                          ...
                                                          // yo shapes ko ho .....lagi kunai kunai render bhachaina 
                                                          //not finished
  for (var i = 0; i < 60; i += 1) {
    ...
    var circle = Bodies.circle(x, y, Common.random(2, 8), {
      ...
      frictionAir: 0.01,
      render: {
        fillStyle: r > 0.3 ? `#42b198` : `rgb(240,240,240)`,
        strokeStyle: `#3257E8`,
        lineWidth: 2 } });
    ...
    var circle = Bodies.circle(x, y, Common.random(2, 20), {
      ...
      frictionAir: 0,
      render: {
        fillStyle: r > 0.3 ? `#4dabb1` : `rgb(240,240,240)`,
        strokeStyle: `#3257E8`,
        lineWidth: 4 } });
  ...
  Events.on(engine, 'afterUpdate', function () {
    ...
    Body.translate(attractiveBody, {
      ...
      y: (mouse.position.y - attractiveBody.position.y) * 0.12 });
                                                ...
                                                // code optimize garna milchha just by using  one function 
